...
def main():
    ...
    gripper_maximum = float(rospy.get_param("~gripper_maximum", 0.10))
    ...
    while not rospy.is_shutdown():
        ...
        if gripper_enabled:
            # Pika already supplies a bounded 0..gripper_maximum target.  The
            # gripper follows it directly; only J1-J6 use motion smoothing.
            positions.append(current_gripper_target)
        last = now
        message = JointState()

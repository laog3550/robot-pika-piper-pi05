...
grep -q -- 'data_msgs piper_msgs piper_description pika_remote_piper piper' "$repo_root/scripts/build_catkin.sh"
grep -q -- 'data_msgs piper_msgs piper_description pika_remote_piper piper' "$repo_root/scripts/setup_rosdep.sh"
